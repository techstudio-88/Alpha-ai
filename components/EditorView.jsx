    ...
    {renderMessage&&<div className="editorRenderStatus">{renderMessage}</div>}<div className="editorWorkspace">
      ...
      <main className="editorMain">
        ...
        <section className="editorTimelinePanel" style={{height:timelineHeight}}>
          <div className="editorControlsStrip">
            <div><label>Timeline height</label><input type="range" min={170} max={520} value={timelineHeight} onChange={e=>setTimelineHeight(Number(e.target.value))}/><b>{timelineHeight}px</b></div>
            <div><label>Video block</label><input type="range" min={36} max={120} value={videoBlockHeight} onChange={e=>setVideoBlockHeight(Number(e.target.value))}/><input type="range" min={60} max={100} value={videoBlockWidth} onChange={e=>setVideoBlockWidth(Number(e.target.value))} aria-label="Video block width"/></div>
            <div><label>Caption block</label><input type="range" min={36} max={120} value={captionBlockHeight} onChange={e=>setCaptionBlockHeight(Number(e.target.value))}/><input type="range" min={60} max={100} value={captionBlockWidth} onChange={e=>setCaptionBlockWidth(Number(e.target.value))} aria-label="Caption block width"/></div>
          </div>

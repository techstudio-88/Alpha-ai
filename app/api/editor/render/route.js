...
export async function POST(request){
  try{
    ...
    const{workspaceId,projectId,mediaAssetId,startSeconds,endSeconds,title}=body||{};
    ...
    const payload={operation:"render_edit",workspaceId,projectId,mediaAssetId,requestedBy:user.id,startSeconds:start,endSeconds:end,title:String(title||asset.name||"Edited clip").slice(0,180)};
